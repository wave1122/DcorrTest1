...
int main(void) {
    ...
    dir_name = "./Results/ML/CC-MGARCH/BL/";
    ...
    output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
																													+ "_bartlett_kernel_cc_mgarch.txt";
	...
	ML_dcorr_power::cValue<NL_Dgp::gen_CC_MGARCH, ML_DCORR::do_Test_bt<ML_REG::RF_cv1, ML_REG::RF_Plot, bartlett_kernel>, bartlett_kernel> \
															(	asymp_REJF, empir_CV,
	...
	ML_dcorr_power::power_f<NL_Dgp::gen_CC_MGARCH, ML_DCORR::do_Test_bt<ML_REG::RF_cv1, ML_REG::RF_Plot, bartlett_kernel>, bartlett_kernel> \
	...
	// Creating a directory
    dir_name = "./Results/ML/CC-MGARCH/DN/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
    ...
    //calculate 5%- and 10%- asymptotic sizes and empirical critical values
	ML_dcorr_power::cValue<NL_Dgp::gen_CC_MGARCH, ML_DCORR::do_Test_bt<ML_REG::RF_cv1, ML_REG::RF_Plot, daniell_kernel>, daniell_kernel> \
															(	asymp_REJF, empir_CV,
																bootstrap_REJF, /*5%- and 10% bootstrap sizes*/
																theta1, theta2, /*true parameters of two DGPs*/
																number_sampl, /*number of random samples drawn*/
    ...
    choose_alt = 1;  //correlation (between eta1 and eta2) = 0.3
	ML_dcorr_power::power_f<NL_Dgp::gen_CC_MGARCH, ML_DCORR::do_Test_bt<ML_REG::RF_cv1, ML_REG::RF_Plot, daniell_kernel>, daniell_kernel> \
															(	empir_REJF, asymp_REJF,
																bootstrap_REJF, /*5%- and 10%- bootstrap rejection frequencies*/
																theta1, theta2, /*true parameters of two DGPs*/
																number_sampl, /*number of random samples drawn*/
    ...
    /************************************************************ Using the QS kernel ***********************************************************************/
    // Creating a directory
    dir_name = "./Results/ML/CC-MGARCH/QS/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
    ...
    //calculate 5%- and 10%- asymptotic sizes and empirical critical values
	ML_dcorr_power::cValue<NL_Dgp::gen_CC_MGARCH, ML_DCORR::do_Test_bt<ML_REG::RF_cv1, ML_REG::RF_Plot, QS_kernel>, QS_kernel> \
															(	asymp_REJF, empir_CV,
																bootstrap_REJF, /*5%- and 10% bootstrap sizes*/
																theta1, theta2, /*true parameters of two DGPs*/
																number_sampl, /*number of random samples drawn*/
    ...
    choose_alt = 1;  //correlation (between eta1 and eta2) = 0.3
	ML_dcorr_power::power_f<NL_Dgp::gen_CC_MGARCH, ML_DCORR::do_Test_bt<ML_REG::RF_cv1, ML_REG::RF_Plot, QS_kernel>, QS_kernel> \
															(	empir_REJF, asymp_REJF,
																bootstrap_REJF, /*5%- and 10%- bootstrap rejection frequencies*/
																theta1, theta2, /*true parameters of two DGPs*/
																number_sampl, /*number of random samples drawn*/
