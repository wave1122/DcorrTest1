...
int main(void) {
	...
	/***************************************************** True DGP: VAR(1) and Fitted GDP: VAR(1) *******************************************************/
    ...
    int T = 100;
    int lag_smooth = 10; /*3, 5, 7, 10, 20, 25*/
    int choose_alt = 0;
    double h = 0.005; /*a differential factor to compute numerical derivatives*/
    ...
    dir_name = "./Results/Others/VAR/BL/";
	...
	output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_bartlett_kernel_var.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_bartlett_kernel_var.txt";
	power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_bartlett_kernel_var.txt";
	...
	//calculate empirical critical values and sizes
     Others_power::cValue<NL_Dgp::gen_VAR,HSIC::kernel,HSIC::kernel, NL_Dgp::estimate_VAR1, NL_Dgp::gen_VAR, NL_Dgp::resid_VAR1,\
    ...
    Others_power::power_f<NL_Dgp::gen_VAR,HSIC::kernel,HSIC::kernel, NL_Dgp::estimate_VAR1, NL_Dgp::gen_VAR, NL_Dgp::resid_VAR1,\
								NL_Dgp::sse_VAR1_gradient, NL_Dgp::sse_VAR1_hessian,bartlett_kernel> \
						(	HSIC_J1_REJF, /*rejection rates of Wang et al.'s (2021) HSIC-based J1 test*/
							HSIC_J2_REJF, /*rejection rates of Wang et al.'s (2021) HSIC-based J2 test*/
    ...
    //***********************************************************using the Daniell kernel*************************************************************************
 	// Creating a directory
    dir_name = "./Results/Others/VAR/DN/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
	...
	output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_daniell_kernel_var.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_daniell_kernel_var.txt";
	power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_daniell_kernel_var.txt";
	output.open (output_filename.c_str(), ios::out);
	size_out.open (size_filename.c_str(), ios::out);
	pwr_out.open (power_filename.c_str(), ios::out);
    ...
    //******************************************************************using the QS kernel***********************************************************************
	// Creating a directory
    dir_name = "./Results/Others/VAR/QS/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
	...
	output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_QS_kernel_var.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_QS_kernel_var.txt";
	power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_QS_kernel_var.txt";
