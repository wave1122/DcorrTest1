...
int main(void) {
    ...
    /************************************************** True DGP: CC_MGARCH(1) and Fitted DGP: VAR-CC-MGARCH(1,1) ***************************************************************/
	unsigned long int seed = 1535;
	int T = 200;
	int lag_smooth = 5; // set M_T = 3, 5, 7, 10, 20, and 25
	double expn = 1.5;
...
//	SGVector<double> theta_var_mgarch2 {-1.5, 1.2, -0.9, 0.5, 0.2, 0.8, 0.1, 0.2, 0.8, 0.1, 0.5};
    ...
    dir_name = "./Results/VAR_CC_MGARCH/CC_MGARCH/BL/";
    ...
    output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_bartlett_kernel_mgarch_data.txt";
	...
	VAR_CC_MGARCH_dcorr_power::cValue<NL_Dgp::gen_CC_MGARCH, bartlett_kernel> (asymp_REJF, empir_CV,
	...
	VAR_CC_MGARCH_dcorr_power::power_f<NL_Dgp::gen_CC_MGARCH, bartlett_kernel>(empir_REJF, asymp_REJF,
																		bootstrap_REJF, /*5% and 10% bootstrap rejection frequencies*/
																		theta_mgarch1, theta_mgarch2, /*true parameters of two DGPs*/
																		theta_mgarch1, theta_mgarch2, /*7 by 1 vector of initial values
																																	used to initialize the MLE estimator for VAR-CC-MGARCH(1,1)*/
	...
	// Creating a directory
    dir_name = "./Results/VAR_CC_MGARCH/CC_MGARCH/DN/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
    else
    ...
    output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_daniell_kernel_mgarch_data.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_daniell_kernel_mgarch_data.txt";
    power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_daniell_kernel_mgarch_data.txt";
	...
	size_out << "====================================================== Compute sizes ==================================================" << endl;
    //calculate 5%- and 10%- asymptotic sizes and empirical critical values
	VAR_CC_MGARCH_dcorr_power::cValue<NL_Dgp::gen_CC_MGARCH, daniell_kernel> (asymp_REJF, empir_CV,
																		bootstrap_REJF, /*5% and 10% bootstrap rejection frequencies*/
																		theta_mgarch1, theta_mgarch2, /*true parameters of two DGPs*/
																		theta_mgarch1, theta_mgarch2, /*7 by 1 vector of initial values
																																used to initialize the MLE estimator for VAR-CC-MGARCH(1,1)*/
    ...
    pwr_out << "===================================================== Compute power =================================================" << endl;
	VAR_CC_MGARCH_dcorr_power::power_f<NL_Dgp::gen_CC_MGARCH, daniell_kernel>(empir_REJF, asymp_REJF,
																		bootstrap_REJF, /*5% and 10% bootstrap rejection frequencies*/
																		theta_mgarch1, theta_mgarch2, /*true parameters of two DGPs*/
																		theta_mgarch1, theta_mgarch2, /*7 by 1 vector of initial values
																												used to initialize the MLE estimator for VAR-CC-MGARCH(1,1)*/
    ...
    /************************************************************ Using the QS kernel ***********************************************************************/
	// Creating a directory
    dir_name = "./Results/VAR_CC_MGARCH/CC_MGARCH/QS/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
    else
	...
	size_out << "====================================================== Compute sizes ==================================================" << endl;
    //calculate 5%- and 10%- asymptotic sizes and empirical critical values
	VAR_CC_MGARCH_dcorr_power::cValue<NL_Dgp::gen_CC_MGARCH, QS_kernel> (asymp_REJF, empir_CV,
																		bootstrap_REJF, /*5% and 10% bootstrap rejection frequencies*/
																		theta_mgarch1, theta_mgarch2, /*true parameters of two DGPs*/
																		theta_mgarch1, theta_mgarch2, /*7 by 1 vector of initial values
																																	used to initialize the MLE estimator for VAR-CC-MGARCH(1,1)*/
    ...
    pwr_out << "===================================================== Compute power =================================================" << endl;
	VAR_CC_MGARCH_dcorr_power::power_f<NL_Dgp::gen_CC_MGARCH, QS_kernel>(empir_REJF, asymp_REJF,
																		bootstrap_REJF, /*5% and 10% bootstrap rejection frequencies*/
																		theta_mgarch1, theta_mgarch2, /*true parameters of two DGPs*/
																		theta_mgarch1, theta_mgarch2, /*7 by 1 vector of initial values
																												used to initialize the MLE estimator for VAR-CC-MGARCH(1,1)*/
