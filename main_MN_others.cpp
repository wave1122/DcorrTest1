...
int main(void) {
    ...
    //*************************************************************using the Bartlett kernel****************************************************************************/
     output_filename = "./Results/NonGaussian/MN/Others/file_out_BL_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(bandW) + "_rho=" + std::to_string(rho)
                                     + "_bartlett_kernel_univariate.txt";
	size_filename = "./Results/NonGaussian/MN/Others/size_out_BL_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(bandW) + "_rho=" + std::to_string(rho)
                                     + "_bartlett_kernel_univariate.txt";
     power_filename = "./Results/NonGaussian/MN/Others/power_out_BL_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(bandW) + "_rho=" + std::to_string(rho)
                                     + "_bartlett_kernel_univariate.txt";
     output.open (output_filename.c_str(), ios::out);
	...
	//calculate empirical critical values and sizes
     Dep_tests::cValue <bartlett_kernel, NL_Dgp::gen_Bilinear<NL_Dgp::gen_MN>, NL_Dgp::est_BL> (REJF_Hong, REJF_ECFTest, REJF_Haugh, empir_CV_Hong, empir_CV_ECFTest,
	...
	choose_alt = 1; //correlated errors
     Dep_tests::power_f<bartlett_kernel, NL_Dgp::gen_Bilinear<NL_Dgp::gen_MN>, NL_Dgp::est_BL> (empir_REJF_Hong, asymp_REJF_Hong, empir_REJF_ECFTest, asymp_REJF_ECFTest,
	...
	size_filename = "./Results/NonGaussian/MN/Others/size_out_BL_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(bandW) + "_rho=" + std::to_string(rho)
     ...
     output << "Lag smooth length = " << bandW << endl;
	//calculate empirical critical values and sizes
     Dep_tests::cValue <daniell_kernel, NL_Dgp::gen_Bilinear<NL_Dgp::gen_MN>, NL_Dgp::est_BL> (REJF_Hong, REJF_ECFTest, REJF_Haugh, empir_CV_Hong, empir_CV_ECFTest,
                                                                                                                empir_CV_Haugh, alpha_X, alpha_Y, asymp_CV_Hong, asymp_CV_Haugh, number_sampl, T, bandW, 0., seed, size_out);
     output << "Hong's (1996) spectral test: empirical 5%- and 10%- critical value for lag_smooth = " << bandW << " and rho= " << rho <<  " are "  << "(" << empir_CV_Hong(1) << " , "
                 << empir_CV_Hong(2) << ")" << endl;
     output << "Hong's (1996) spectral test: asymptotic 5%- and 10%- critical value for lag_smooth = " << bandW << " and rho= " << rho <<  " are " << "(" << asymp_CV_Hong(1) << " , "
	...
	//calculate rejection rates
	choose_alt = 1;
     Dep_tests::power_f<daniell_kernel, NL_Dgp::gen_Bilinear<NL_Dgp::gen_MN>, NL_Dgp::est_BL> (empir_REJF_Hong, asymp_REJF_Hong, empir_REJF_ECFTest, asymp_REJF_ECFTest,
                                                                                                                                                                                empir_REJF_Haugh, asymp_REJF_Haugh, alpha_X, alpha_Y, empir_CV_Hong,
                                                                                                                                                                                asymp_CV_Hong, empir_CV_ECFTest, asymp_CV_Hong, empir_CV_Haugh,
                                                                                                                                                                                asymp_CV_Haugh, number_sampl, T, bandW, 0., rho, choose_alt, seed, pwr_out);
     output << "-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
	...
	size_filename = "./Results/NonGaussian/MN/Others/size_out_BL_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(bandW) + "_rho=" + std::to_string(rho)
     ...
     output << "Lag smooth length = " << bandW << endl;
	//calculate empirical critical values and sizes
     Dep_tests::cValue <QS_kernel, NL_Dgp::gen_Bilinear<NL_Dgp::gen_MN>, NL_Dgp::est_BL> (REJF_Hong, REJF_ECFTest, REJF_Haugh, empir_CV_Hong, empir_CV_ECFTest,
                                                                                                                empir_CV_Haugh, alpha_X, alpha_Y, asymp_CV_Hong, asymp_CV_Haugh, number_sampl, T, bandW, 0., seed, size_out);
     output << "Hong's (1996) spectral test: empirical 5%- and 10%- critical value for lag_smooth = " << bandW << " and rho= " << rho <<  " are "  << "(" << empir_CV_Hong(1) << " , "
                 << empir_CV_Hong(2) << ")" << endl;
     output << "Hong's (1996) spectral test: asymptotic 5%- and 10%- critical value for lag_smooth = " << bandW << " and rho= " << rho <<  " are " << "(" << asymp_CV_Hong(1) << " , "
	...
	//calculate rejection rates
	choose_alt = 1;
     Dep_tests::power_f<QS_kernel, NL_Dgp::gen_Bilinear<NL_Dgp::gen_MN>, NL_Dgp::est_BL> (empir_REJF_Hong, asymp_REJF_Hong, empir_REJF_ECFTest, asymp_REJF_ECFTest,
                                                                                                                                                                                empir_REJF_Haugh, asymp_REJF_Haugh, alpha_X, alpha_Y, empir_CV_Hong,
                                                                                                                                                                                asymp_CV_Hong, empir_CV_ECFTest, asymp_CV_Hong, empir_CV_Haugh,
                                                                                                                                                                                asymp_CV_Haugh, number_sampl, T, bandW, 0., rho, choose_alt, seed, pwr_out);
     output << "-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
