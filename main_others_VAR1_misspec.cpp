...
int main(void) {
	...
	/******************************************************* True DGP: VAR(1) and Fitted GDP: CC-MGARCH(1, 1) *******************************************************/
    ...
    dir_name = "./Results/Others/VAR_misspec/BL/";
	...
	output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_bartlett_kernel_var_misspec.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_bartlett_kernel_var_misspec.txt";
	power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_bartlett_kernel_var_misspec.txt";
    ...
    //***********************************************************using the Daniell kernel*************************************************************************
 	// Creating a directory
    dir_name = "./Results/Others/VAR_misspec/DN/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
 	...
 	output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_daniell_kernel_var_misspec.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_daniell_kernel_var_misspec.txt";
	power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_daniell_kernel_var_misspec.txt";
	output.open (output_filename.c_str(), ios::out);
	size_out.open (size_filename.c_str(), ios::out);
	pwr_out.open (power_filename.c_str(), ios::out);
    ...
    //******************************************************************using the QS kernel***********************************************************************
	// Creating a directory
    dir_name = "./Results/Others/VAR_misspec/QS/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
	...
	output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_QS_kernel_var_misspec.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_QS_kernel_var_misspec.txt";
	power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_QS_kernel_var_misspec.txt";
	output.open (output_filename.c_str(), ios::out);
	size_out.open (size_filename.c_str(), ios::out);
	pwr_out.open (power_filename.c_str(), ios::out);
