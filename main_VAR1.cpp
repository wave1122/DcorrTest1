...
int main(void) {
	...
	*/
    ...
    int T = 100;
	int L = 2;
	int lag_smooth = 10; //set M_T = 5, 10, 20, and 25
	double expn = 1.5;
    ...
    output_filename = "./Results/ML/VAR/BL/file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_bartlett_kernel_var.txt";
	size_filename = "./Results/ML/VAR/BL/size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_bartlett_kernel_var.txt";
    power_filename = "./Results/ML/VAR/BL/power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_bartlett_kernel_var.txt";
    output.open (output_filename.c_str(), ios::out);
    ...
    int choose_alt = 1;  //correlation (between eta1 and eta2) = 0.3
	...
	output_filename = "./Results/ML/VAR/DN/file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_daniell_kernel_var.txt";
	size_filename = "./Results/ML/VAR/DN/size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_daniell_kernel_var.txt";
    power_filename = "./Results/ML/VAR/DN/power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_daniell_kernel_var.txt";
    output.open (output_filename.c_str(), ios::out);
    size_out.open (size_filename.c_str(), ios::out);
    pwr_out.open (power_filename.c_str(), ios::out);
    ...
    //calculate 5%- and 10%- asymptotic sizes and empirical critical values
	ML_dcorr_power::cValue<NL_Dgp::gen_VAR, ML_DCORR::do_Test<ML_REG::RF_cv1, ML_REG::RF_Plot, daniell_kernel>, daniell_kernel> (asymp_REJF, empir_CV,
								theta1, theta2, /*true parameters of two DGPs*/
								number_sampl, /*number of random samples drawn*/
								T, /*sample size*/
								L, /*maximum truncation lag*/
	...
	ML_dcorr_power::power_f<NL_Dgp::gen_VAR, ML_DCORR::do_Test<ML_REG::RF_cv1, ML_REG::RF_Plot, daniell_kernel>, daniell_kernel> (empir_REJF, asymp_REJF,
									theta1, theta2, /*true parameters of two DGPs*/
									number_sampl, /*number of random samples drawn*/
									T, /*sample size*/
									L, /*maximum truncation lag*/
    ...
    /************************************************************ Using the QS kernel ***********************************************************************/
    output_filename = "./Results/ML/VAR/QS/file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_QS_kernel_var.txt";
	size_filename = "./Results/ML/VAR/QS/size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_QS_kernel_var.txt";
    power_filename = "./Results/ML/VAR/QS/power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_expn=" + std::to_string(expn)
                                   + "_QS_kernel_var.txt";
    output.open (output_filename.c_str(), ios::out);
    size_out.open (size_filename.c_str(), ios::out);
    pwr_out.open (power_filename.c_str(), ios::out);
    ...
    //calculate 5%- and 10%- asymptotic sizes and empirical critical values
	ML_dcorr_power::cValue<NL_Dgp::gen_VAR, ML_DCORR::do_Test<ML_REG::RF_cv1, ML_REG::RF_Plot, QS_kernel>, QS_kernel> (asymp_REJF, empir_CV,
								theta1, theta2, /*true parameters of two DGPs*/
								number_sampl, /*number of random samples drawn*/
								T, /*sample size*/
								L, /*maximum truncation lag*/
    ...
    choose_alt = 1;  //correlation (between eta1 and eta2) = 0.3
	ML_dcorr_power::power_f<NL_Dgp::gen_VAR, ML_DCORR::do_Test<ML_REG::RF_cv1, ML_REG::RF_Plot, QS_kernel>, QS_kernel> (empir_REJF, asymp_REJF,
									theta1, theta2, /*true parameters of two DGPs*/
									number_sampl, /*number of random samples drawn*/
									T, /*sample size*/
									L, /*maximum truncation lag*/
