...
int main(void) {
	...
	/**************************************************** IMPORT THE FIRST DATASET *************************************************************/
     ifstream readX; //case counts
	readX.open ("E:\\Dropbox\\Teaching\\Ph.D\\Shafiullah Qureshi\\Covid-19 impact\\Data\\US\\log_case_count_AR_resid1.csv", ios::in);
	if (!readX)
        return(EXIT_FAILURE);
    ...
    /*************************************************** IMPORT THE SECOND DATASET **************************************************************/
     ifstream readY; //GT
	readY.open ("E:\\Dropbox\\Teaching\\Ph.D\\Shafiullah Qureshi\\Covid-19 impact\\Data\\US\\GT_GARCH_resid1.csv", ios::in);
	if (!readY)
        return(EXIT_FAILURE);
 ...
 /************************************************************************************************************************************************/
    ...
    int lag_smooth = 5; //set a kernel bandwidth: 5, 10, 15, 20, 25, 30, 35, 40, 45
	...
	auto cstat = 0.;
	Matrix cstat_bootstrap(num_B, 1);
	auto pvalue = NGDist_corr::calcul_Pvalue <QS_kernel> (cstat, cstat_bootstrap, X, Y, cmean_X, cmean_Y, csigma_X, csigma_Y, resid_X, resid_Y, lag_smooth, xi_x,  xi_y, expn);

    ofstream  output; //open an output stream
    string output_filename = "E:\\Dropbox\\Teaching\\Ph.D\\Shafiullah Qureshi\\Covid-19 impact\\Data\\US\\results_T=" + std::to_string(T) + "_lag_smooth=" + std::to_string(lag_smooth) + "_expn="
