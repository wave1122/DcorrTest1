...
int main(void) {
	...
	/***************************************************** True DGP: CC-MGARCH and Fitted GDP: CC-MGARCH *******************************************************/
    ...
    int T = 100;
    int lag_smooth = 7; /*3, 5, 7, 10, 20, 25*/
    ...
    dir_name = "./Results/Others/CC-MGARCH/BL/";
	...
	output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_bartlett_kernel_cc_mgarch.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_bartlett_kernel_cc_mgarch.txt";
	power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_bartlett_kernel_cc_mgarch.txt";
	...
	//calculate empirical critical values and sizes
     Others_power::cValue<NL_Dgp::gen_CC_MGARCH,HSIC::kernel,HSIC::kernel,cc_mgarch::mle_simplex,NL_Dgp::gen_CC_MGARCH,NL_Dgp::resid_CC_MGARCH,\
								cc_mgarch::neg_loglikelihood_gradient, cc_mgarch::neg_loglikelihood_hessian,bartlett_kernel> \
						(	HSIC_J1_REJF, /*rejection rates of Wang et al.'s (2021) HSIC-based J1 test*/
							...
							theta_mgarch1, theta_mgarch2, /*true parameters of two DGPs*/
							theta_mgarch1, theta_mgarch2, /*initial values used to estimate DGPs*/
    ...
    //***********************************************************using the Daniell kernel*************************************************************************
 	// Creating a directory
    dir_name = "/Results/Others/CC-MGARCH/DN/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
 	...
 	output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_daniell_kernel_cc_mgarch.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_daniell_kernel_cc_mgarch.txt";
	power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_daniell_kernel_cc_mgarch.txt";
	output.open (output_filename.c_str(), ios::out);
	size_out.open (size_filename.c_str(), ios::out);
	pwr_out.open (power_filename.c_str(), ios::out);
    ...
    //******************************************************************using the QS kernel***********************************************************************
	// Creating a directory
    dir_name = "./Results/Others/CC-MGARCH/QS/";
    new_dir = dir_name.c_str();
    if (mkdir(new_dir, 0777) == -1)
        cerr << "Error :  " << strerror(errno) << endl;
	...
	output_filename = dir_name + "file_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_QS_kernel_cc_mgarch.txt";
	size_filename = dir_name + "size_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_QS_kernel_cc_mgarch.txt";
	power_filename = dir_name + "power_out_T=" + std::to_string(T) +  "_lag_smooth=" + std::to_string(lag_smooth) + "_QS_kernel_cc_mgarch.txt";
	...
	//calculate empirical critical values and sizes
     Others_power::cValue<NL_Dgp::gen_CC_MGARCH,HSIC::kernel,HSIC::kernel,cc_mgarch::mle_simplex,NL_Dgp::gen_CC_MGARCH,NL_Dgp::resid_CC_MGARCH,\
								cc_mgarch::neg_loglikelihood_gradient, cc_mgarch::neg_loglikelihood_hessian,QS_kernel> \
						(	HSIC_J1_REJF, /*rejection rates of Wang et al.'s (2021) HSIC-based J1 test*/
							HSIC_J2_REJF, /*rejection rates of Wang et al.'s (2021) HSIC-based J2 test*/
							ER_asymp_REJF, /*asymptotic rejection rates of El Himdi and Roy's (1997) test*/
							ER_empir_CV, /*5% and 10% empirical critical values of El Himdi and Roy's (1997) test*/
