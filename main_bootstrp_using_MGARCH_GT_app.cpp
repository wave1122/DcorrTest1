...
int main(void) {
	...
	readX.open ("E:\\Copy\\SCRIPTS\\Exogeneity\\Application\\data\\GT\\stocks_GARCH_resid_2020_US2a.csv", ios::in);
	if (!readX)
        return(EXIT_FAILURE);
    ...
    /*************************************************** IMPORT THE SECOND DATASET **************************************************************/
     ifstream readY; //GT
	readY.open ("E:\\Copy\\SCRIPTS\\Exogeneity\\Application\\data\\GT\\GT_GARCH_resid_2020_US2a.csv", ios::in);
	if (!readY)
        return(EXIT_FAILURE);
 ...
 /************************************************************************************************************************************************/
	...
	for (auto ii : lag_smooth) {
			string output_filename = "E:\\Copy\\SCRIPTS\\Exogeneity\\Application\\output\\GT\\US2\\results_T=" + std::to_string(T) + "_lag_smooth=" + std::to_string(ii) + "_expn="
